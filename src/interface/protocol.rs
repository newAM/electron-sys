...
extern {
    ...
    pub fn intercept_buffer_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
    ...
    pub fn intercept_file_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
        completion: Option<&Function>,
    ...
    pub fn intercept_http_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
        completion: Option<&Function>,
    ...
    pub fn intercept_stream_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
        completion: Option<&Function>,
    ...
    pub fn intercept_string_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
        completion: Option<&Function>,
    ...
    pub fn register_buffer_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
        completion: Option<&Function>,
    ...
    pub fn register_string_protocol(
        this: &Protocol,
        scheme: &JsString,
        handler: &Function,
        completion: Option<&Function>,
    ...
    pub fn unintercept_protocol(this: &Protocol, scheme: &JsString, completion: Option<&Function>);

    #[wasm_bindgen(method, js_name = "unregisterProtocol")]
    pub fn unregister_protocl(this: &Protocol, scheme: &JsString, completion: Option<&Function>);
}
